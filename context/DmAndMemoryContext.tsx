...
export function DMAndMemProvider({ children }: PropsWithChildren) {
  ...
  const prepareIteration = ({
    ...
    const i_: IterationDMAndMem = {
      idIteration: i.id,
      dmVideo: i.answers.length ? i.answers.find((a) => a.videoType =="dm")?.video1.video : undefined,
      memoryVideo: i.answers.length ? i.answers.find((a) => a.videoType =="memory")?.video1.video : undefined,
      dmAnswer1: i.answers.length ? i.answers.find((a) => a.videoType =="dm")?.video1.answer1 : undefined,
      dmAnswer2: i.answers.length ? i.answers.find((a) => a.videoType =="dm")?.video1.answer2 : undefined,
      memoryAnswer1: i.answers.length ? Number(i.answers.find((a) => a.videoType =="memory")?.video1.answer1) : undefined,
      memoryAnswer2: i.answers.length ? Number(i.answers.find((a) => a.videoType =="memory")?.video1.answer2) : undefined,
...
const getOptions = (i: Iteration) => {
  const a1 = i.answers.length ? Number(i.answers.find((a) => a.videoType =="memory")?.video1.answer1) : undefined;
  const a2 = i.answers.length ? Number(i.answers.find((a) => a.videoType =="memory")?.video1.answer2) : undefined;
